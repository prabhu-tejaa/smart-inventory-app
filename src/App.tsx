        ...
        <div className="flex items-center gap-3">
          {user?.role === 'admin' && (
            <button 
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-md text-xs font-semibold hover:bg-indigo-100 transition-colors cursor-pointer"
            >
              <ShieldAlert className="w-4 h-4" /> Admin Console
            </button>
          )}
          <button onClick={handleLogout} className="text-xs font-semibold text-slate-500 flex items-center gap-1 hover:text-slate-800 cursor-pointer">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-3 shadow-2xs">
                ...
                <div className="flex items-center gap-2 self-end md:self-center">
                  <button 
                    ...
                    className="text-xs font-semibold px-3 py-1.5 bg-amber-100 hover:bg-amber-200 text-amber-900 transition-colors rounded-lg flex items-center gap-1 cursor-pointer"
                  >
                    View Expired
                  ...
                  <button 
                    ...
                    className="text-xs font-semibold px-3 py-1.5 bg-slate-900/10 hover:bg-slate-900/20 text-slate-800 transition-colors rounded-lg cursor-pointer"
                  >
                    View Low Stocks
                  </button>
                  <button 
                            ...
                            <button
                              ...
                              className={`p-1.5 px-2.5 rounded-lg border text-xs font-semibold cursor-pointer transition-all duration-150 flex items-center justify-center gap-1 mx-auto ${
                                isOutOfStock 
                                  ...
                                  : "bg-white hover:bg-slate-900 text-slate-800 hover:text-white border-slate-200 hover:border-slate-900 shadow-2xs cursor-pointer"
                              }`}
                      ...
                      <button
                        ...
                        className={`w-full mt-2 py-2 px-4 rounded-lg shadow-sm font-display text-xs font-semibold cursor-pointer transition-all flex items-center justify-center gap-1.5 ${
                          liveEstimates && liveEstimates.valid
                            ? "bg-emerald-600 hover:bg-emerald-500 active:scale-[0.99] text-white cursor-pointer"
